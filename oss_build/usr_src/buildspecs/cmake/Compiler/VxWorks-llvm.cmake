...
foreach(lang C CXX ASM)
    ...
    set(CMAKE_${lang}_CREATE_SHARED_LIBRARY
	    "${CMAKE_LINKER} $ENV{LINKFORSHARED} $ENV{LDFLAGS_SO} $ENV{LDFLAGS_SHARED} -lc_internal <LINK_FLAGS> <SONAME_FLAG><TARGET_SONAME> -o <TARGET> <OBJECTS> --as-needed ${SHLIBS} <LINK_LIBRARIES>")
