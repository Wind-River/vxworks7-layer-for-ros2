# vxworks.mak - for rosidl_defaults
#
...
ifndef _WRS_CFG_ROSIDL_DEFAULTS_BUILD_SHARED_LIBRARY
ADDED_FLAGS += -DBUILD_SHARED_LIBS=OFF
endif

.PHONY : default

PKG_NAME = rosidl_defaults

PKG_BUILD_DIR = $(PKG_NAME)/build/rosidl_default_generators
