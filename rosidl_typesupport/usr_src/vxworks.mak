# vxworks.mak - for rosidl_typesupport
#
...
ifndef _WRS_CFG_ROSIDL_TYPESUPPORT_SHARED_LIBRARY
ADDED_FLAGS += -DBUILD_SHARED_LIBS=OFF
endif

.PHONY : default

PKG_NAME = rosidl_typesupport
PKG_BUILD_DIR = $(PKG_NAME)/build/$(PKG_NAME)_c
PKG_SRC_DIR = $(PKG_NAME)

ADDED_LIBS  += --as-needed -ldl

ifdef _WRS_CFG_ROSIDL_TYPESUPPORT_WITH_POCO
ADDED_CFLAGS+=-DPOCO_VXWORKS_UNIX
ADDED_LIBS  += -L$(ROOT_DIR)/lib -lPocoFoundation
endif
